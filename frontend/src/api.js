...
export const getClientLoans = (clientId) =>
  api.get(`/clients/${clientId}/loans`);
export const updateLoan = (loanId, payload) =>
  api.put(`/loans/${loanId}`, payload);
export const deleteLoan = (loanId) => api.delete(`/loans/${loanId}`);

// Installment APIs
export const getLoanInstallments = (loanId) =>
  api.get(`/loans/${loanId}/installments`);
export const markInstallmentPaid = (installmentId) =>
  api.put(`/installments/${installmentId}/pay`);
export const updateOverdueStatus = () =>
  api.put("/installments/update-overdue");
export const markAllInstallmentsPaid = (loanId) =>
  api.put(`/loans/${loanId}/mark-all-paid`);
